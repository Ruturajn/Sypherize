...
doxygen:
	@echo "\033[1;34m[+] Re-creating docs directory ...\033[1;37m"
	rm -rf $(DOXYGEN_DIR)
	mkdir -p $(DOXYGEN_DIR)
...
help:
	...
	@echo "    \033[1;35mclean_doxygen\033[1;37m - Remove build files and directories."
	@echo "    \033[1;35mrun\033[1;37m           - Executes all, clean and runs the executable."
	@echo "                    Optionally provide 'FILE_PATH' for running"
	@echo "                    the executable."
	@echo "    \033[1;35mdoxygen\033[1;37m       - Generates documentation, using doxygen."
